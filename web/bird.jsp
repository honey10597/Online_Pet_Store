<%-- 
    Document   : bird
    Created on : 14 Apr, 2019, 9:37:24 PM
    Author     : Honey
--%>
    ...
    <head>
        ...
        <style>
            ...
            .d3{
                ...
                background-image: url("bird3.JPG");
                background-size: 310px 280px;
            }
...
<body>
	<div class="demo">
        ...
        <div class="main">
            <div class="d1"><a href="buynow.jsp"><button >Buy Now</button></a></div>
            <div class="d2"><a href="buynow.jsp"><button >Buy Now</button></a></div>
            <div class="d3"><a href="buynow.jsp"><button >Buy Now</button></a></div>
        </div>
    </body>
    <script>
